...
public:
  ...
  // returns reference to the specified component (0-based indexing: x, y, z, w)
  inline float& operator[](const int& index) {
    return (&x)[index];
  }

  // returns const reference to the specified component (0-based indexing: x, y, z, w)
